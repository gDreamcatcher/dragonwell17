...
public class JmapHeapTest extends TestBase {
    ...
    private static void test(String heap_type) throws Exception {
        ...
        try {
            ...
            // init heap info
            String[] contains1 = {
                "current elastic heap size   600M",
            };
            ...
            String[] contains3 = {
                "current elastic heap size   500M",
            };
            ...
            String[] contains5 = {
                "current elastic heap size   1024M",
            };
    ...
    static void jmapAndCheck(long pid, String[] contains) throws Exception{
        ...
        pb.command(new String[] { JDKToolFinder.getJDKTool("jcmd"), Long.toString(pid), "GC.heap_info"});
