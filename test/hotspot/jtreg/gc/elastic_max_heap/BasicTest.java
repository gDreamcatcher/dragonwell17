...
public class BasicTest extends TestBase {
    ...
    private static void test(String heap_type) throws Exception {
        ProcessBuilder pb = ProcessTools.createLimitedTestJavaProcessBuilder(heap_type, "-XX:+ElasticMaxHeap", "-Xms100M", "-Xmx600M", "-XX:ElasticMaxHeapSize=1G", "NotActiveHeap");
        Process p = pb.start();
        try {
            ...
            resizeAndCheck(pid, "504M", contains1, null);
            ...
            resizeAndCheck(pid, "304M", contains5, null);
        } finally {
            p.destroy();
        }
    }
